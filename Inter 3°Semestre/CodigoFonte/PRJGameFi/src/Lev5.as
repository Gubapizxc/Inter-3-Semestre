package
{
	...
	public class Lev5 extends Sprite
	{   //Variaveis comuns
		...
		private var Lev5nd:TextField = new TextField(360, 240, "", "Arial", 100, 0x9b14e7);
		...
		[Embed(source="../assets/som/lab.mp3")]
		...
		
		{
			...
			le15  = Assets.imagem(Assets.cobrir);
			le15.width = 2048;
			le15.height = 2048;
			le15.x = -300;
			le15.y = -300;
			...
			arte6  = Assets.imagem(Assets.cobrir);
			arte6.width = 2048;
			arte6.height = 2048;
			arte6.x = 1950;
			arte6.y = -300;
			...
			le1 = Assets.imagem(Assets.teste2);
			le1.width = 1000;
			le1.height = 1400;
			le1.x = 2050;
			le1.y = -410;
			...
			le2  = Assets.imagem(Assets.teste);
			le2.width = 2048;
			le2.height = 1400;
			le2.x = 0;
			le2.y = -410;
			...
			arte5  = Assets.imagem(Assets.emenda);
			arte5.width = 2048;
			arte5.height = 1400;
			arte5.x = 30;
			arte5.y = -410;
			meio.addChild(arte5);
			/*ext  = Assets.imagem(Assets.ext);
			ext.width = 2000;
			ext.height = 1600;
			ext.x = -200;
			ext.y = -960;
			...
			criainimigos( 530, 340, 0xff0000, "tigre");
			criainimigos( 600, 440, 0xff0000, "soldado");
			criainimigos( 600, -90, 0xff0000, "passaro");
			criainimigos( 230, -90, 0xff0000, "atira");
			criainimigos( 700, -340, 0xff0000, "atira");
			criainimigos( 100, -340, 0xff0000, "soldado");
			criainimigos( 1000, -340, 0xff0000, "berserk");
			criainimigos( 1150, -240, 0xff0000, "soldado");
			criainimigos( 830, 300, 0xff0000, "soldado");
			criainimigos( 1100, 200, 0xff0000, "tigre");
			criainimigos( 1250, -340, 0xff0000, "soldado");
			criainimigos( 730, 440, 0xff0000, "soldado");
			criainimigos( 1730, 440, 0xff0000, "atira");
			criainimigos( 1500, 300, 0xff0000, "atira");
			criainimigos( 1600, 200, 0xff0000, "tigre");
			criainimigos( 1450, -240, 0xff0000, "atira");
			criainimigos( 1550, -340, 0xff0000, "atira");
			criainimigos( 1700, -200, 0xff0000, "passaro");
			criainimigos( 1800, -340, 0xff0000, "passaro");
			criainimigos( 2700, -340, 0xff0000, "berserk");
			criainimigos( 2900, -140, 0xff0000, "soldado");
			criainimigos( 2350, -10, 0xff0000, "tigre");
			criainimigos( 2300, -10, 0xff0000, "touro");
			criainimigos( 2450, 850, 0xff0000, "shaman");

			
			criainimigos(-3000, 100, 0xff0000, "atira");
			
			criaplataforma( 3000, -510, 50, 1500, 0x00ff00, 1);
			criaplataforma( 0, -810, 50, 1450, 0x00ff00, 1);
			criaplataforma( 0, 340, 400, 50, 0x00ff00, 1);
			criaplataforma( 400, 340, 100, 20, 0x00ff00, 2);
			criaplataforma( 500, 340, 500, 50, 0x00ff00, 1);
			criaplataforma( 1000, 340, 100, 20, 0x00ff00, 2);
			criaplataforma( 1100, 340, 200, 50, 0x00ff00, 1);
			criaplataforma( 1300, 340, 100, 20, 0x00ff00, 2);
			criaplataforma( 1400, 340, 500, 50, 0x00ff00, 1);
			criaplataforma( 650, 340, 50, 200, 0x00ff00, 1);
			criaplataforma( 600, 190, 100, 200, 0x00ff00, 1);
			criaplataforma( 700, -210, 100, 550, 0x00ff00, 1);
			criaplataforma( 0, -210, 250, 50, 0x00ff00, 1);
			criaplataforma( 350, -210, 200, 50, 0x00ff00, 1);
			criaplataforma( 600, -10, 200, 20, 0x00ff00, 2);
			criaplataforma( 550, -210, 200, 20, 0x00ff00, 2);
			criaplataforma( 500, -410, 50, 200, 0x00ff00, 1);
			criaplataforma( 650, -210, 200, 50, 0x00ff00, 1);
			criaplataforma( 750, -210, 200, 20, 0x00ff00, 2);
			criaplataforma( 950, -210, 500, 50, 0x00ff00, 1);
			criaplataforma( 1550, -210, 200, 50, 0x00ff00, 1);
			criaplataforma( 1450, -210, 100, 20, 0x00ff00, 2);
			criaplataforma( 1150, -410, 50, 200, 0x00ff00, 1);
			criaplataforma( 1200, -210, 100, 550, 0x00ff00, 1);
			criaplataforma( 200, -10, 200, 20, 0x00ff00, 2);
			criaplataforma( 1000, -10, 200, 20, 0x00ff00, 2);
			criaplataforma( 1400, -10, 200, 20, 0x00ff00, 2);
			criaplataforma( 1650, 140, 100, 250, 0x00ff00, 1);
			criaplataforma( 1750, -60, 100, 450, 0x00ff00, 1);
			criaplataforma( 0, 540, 1900, 50, 0x00ff00, 1);
			criaplataforma( 1850, -210, 50, 1200, 0x00ff00, 1);
			criaplataforma( 1850, 940, 1900, 50, 0x00ff00, 1);
			criaplataforma( 1850, -210, 1000, 50, 0x00ff00, 1);
			criaplataforma( 1700, -410, 50, 200, 0x00ff00, 1);
			criaplataforma( 0, -1210, 3000, 800, 0x00ff00, 1);
			//criaplataforma( 2450, 40, 50, 200, 0x00ff00, 1);
			criaplataforma( 2100, -60, 50, 800, 0x00ff00, 1);
			criaplataforma( 2100, 140, 1900, 100, 0x00ff00, 1);
			criaplataforma( 2100, 690, 750, 50, 0x00ff00, 1);
			criaplataforma( 2100, 640, 200, 50, 0x00ff00, 1);
			criaplataforma( 2800, 890, 200, 50, 0x00ff00, 1);
			criaplataforma( 2300, 440, 1900, 50, 0x00ff00, 1);
