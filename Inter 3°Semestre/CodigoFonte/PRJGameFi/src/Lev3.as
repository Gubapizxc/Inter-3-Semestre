package
{
	...
	public class Lev3 extends Sprite
	{   //Variaveis comuns
		...
		private var Lev3nd:TextField = new TextField(360, 240, "", "Arial", 100, 0x9b14e7);
		...
		
		{
			...
			*/
			...
			criainimigos(410, 40, 0xff0000, "atira");
			criainimigos(470, 290, 0xff0000, "passaro");
			criainimigos(770, 290, 0xff0000, "soldado");
			criainimigos(1420, 290, 0xff0000, "atira");
			criainimigos(1470, 140, 0xff0000, "atira");
			criainimigos(1420, -10, 0xff0000, "atira");
			criainimigos(1370, 140, 0xff0000, "soldado");
			criainimigos(1170, 140, 0xff0000, "soldado");
			criainimigos(1120, -10, 0xff0000, "soldado");
			criainimigos(1320, 90, 0xff0000, "atira");
			criainimigos(2070, -10, 0xff0000, "atira");
			criainimigos(2320, 200, 0xff0000, "berserk");
			criainimigos(2620, 200, 0xff0000, "berserk");
			criainimigos(2320, 140, 0xff0000, "soldado");
			criainimigos(2370, -10, 0xff0000, "soldado");
			criainimigos(2770, -10, 0xff0000, "atira");
		
			criainimigos(-350, 900, 0xff00ff, "soldado");
			
			criaplataforma( 250, 90, 100, 50, 0x00ff00, 1);
			criaplataforma( 500, 40, 100, 20, 0x00ff00, 2);
			criaplataforma( 400, 140, 50, 100, 0x00ff00, 1);
			criaplataforma( 400, 190, 100, 50, 0x00ff00, 1);
			criaplataforma( 550, 190, 50, 150, 0x00ff00, 1);
			criaplataforma( 850, 240, 50, 150, 0x00ff00, 1);
			criaplataforma( 900, 140, 100, 50, 0x00ff00, 1);
			criaplataforma( 1200, 190, 350, 20, 0x00ff00, 2);
			criaplataforma( 1200, 40, 350, 20, 0x00ff00, 2);
			criaplataforma( 1650, 140, 150, 20, 0x00ff00, 2);
			criaplataforma( 1750, 40, 50, 122, 0x00ff00, 1);
			criaplataforma( 1750, 40, 400, 20, 0x00ff00, 2);
			criaplataforma( 2150, -60, 50, 300, 0x00ff00, 1);
			criaplataforma( 2150, 190, 100, 50, 0x00ff00, 1);
			criaplataforma( 2350, 190, 150, 50, 0x00ff00, 1);
			criaplataforma( 2300, 40, 200, 50, 0x00ff00, 1);
			criaplataforma( 2500, 40, 50, 300, 0x00ff00, 1);
			criaplataforma( 2200, 40, 100, 20, 0x00ff00, 2);
			criaplataforma( 2250, 190, 100, 20, 0x00ff00, 2);
			criaplataforma( 2750, 40, 200, 50, 0x00ff00, 1);
			criaplataforma( 2950, 40, 50, 20, 0x00ff00, 2);
			criaplataforma( 2600, 90, 100, 50, 0x00ff00, 1);
			criaplataforma( 2750, 140, 50, 100, 0x00ff00, 1);
			criaplataforma( 1950, 330, 150, 50, 0x00ffff, 3);
			
			criaplataforma(3000, -510, 500, 900, 0x00ff00, 1);
			criaplataforma(-350, -810, 500, 1200, 0x00ff00, 1);
			criaplataforma( 0, 340, 3000, 50, 0x00ff00, 1);
			criaplataforma( 0, -860, 3000, 800, 0x00ff00, 1);
