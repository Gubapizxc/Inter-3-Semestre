package
{
	...
	public class Lev1 extends Sprite
	{   //Variaveis comuns
		...
		private var Lev1nd:TextField = new TextField(360, 240, "", "Arial", 100, 0x9b14e7);
		...
		[Embed(source="../assets/som/fase.mp3")]
		...
		[Embed(source = "../assets/som/andar.mp3")] 
		...
		
		{
			...
			criainimigos(600, 239, 0xff0000, "soldado");
			//criainimigos(700, 239, 0xff0000, "soldado");
			criainimigos(1300, 239, 0xff0000, "soldado");
			criainimigos(2400, 239, 0xff0000, "soldado");
			//criainimigos(2660, 270, 0xff0000, "soldado");
			criainimigos(1205, 200, 0xff0000, "atira");
			criainimigos(2920, 30, 0xff0000, "atira")
			criainimigos(1790, -60, 0xff0000, "atira");
			//criainimigos(1860, 100, 0xff0000, "atira");
			criainimigos(-350, 900, 0xff00ff, "atira");
			
			
			criaplataforma(3000, -510, 500, 900, 0x00ff00, 1);
			criaplataforma(-350, -810, 500, 1200, 0x00ff00, 1);
			criaplataforma(450, 190, 50, 200, 0x00ff00, 1);
			criaplataforma(1250, 190, 50, 200, 0x00ff00, 1);
			criaplataforma(1200, 290, 50, 70, 0x00ff00, 1);
		    criaplataforma(1650, 240, 100, 20, 0x00ffff, 1);
			criaplataforma(1850, 190, 100, 20, 0x00ffff, 2);
			criaplataforma(1750, 40, 100, 20, 0x00ffff, 2);
			criaplataforma(2100, 190, 50, 200, 0x00ff00, 1);
			criaplataforma(2650, 140, 50, 300, 0x00ff00, 1);
			criaplataforma(2650, 140, 100, 50, 0x00ff00, 1);
			criaplataforma(2900, 90, 100, 50, 0x00ff00, 1);
			//criaplataforma(340, 134, 120, 20, 0x00ffff, 2);
			//criaplataforma(500, 330, 100, 20, 0x0000ff,3);
			//criaplataforma(150, 330, 50, 20, 0xff0000,4);
			criaplataforma( -3500, 340, 7000, 100, 0x00ff00, 1);
		//	criaplataforma( -3500, -100, 7000, 250, 0x00ff00, 1);
