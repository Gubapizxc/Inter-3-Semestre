package
{
	...
	public class Lev4 extends Sprite
	{   //Variaveis comuns
		...
		private var Lev4nd:TextField = new TextField(360, 240, "", "Arial", 100, 0x9b14e7);
		...
		[Embed(source="../assets/som/zoo.mp3")]
		...
		
		{
			...
			arte  = Assets.imagem(Assets.zoofundo1);
			arte.width = 2600;
			arte.height = 1600;
			arte.x = -300;
			arte.y = -620;
			...
			arte2  = Assets.imagem(Assets.zoofundo2);
			arte2.width = 1300;
			arte2.height = 1600;
			arte2.x = 2600;
			arte2.y = -620;
			...
			arte3  = Assets.imagem(Assets.zoomeio1);
			arte3.width = 2048;
			arte3.height = 1400;
			arte3.x = -500;
			arte3.y = -500;
			...
			arte4  = Assets.imagem(Assets.zoomeio2);
			arte4.width = 1000;
			arte4.height = 1400;
			arte4.x = 1500;
			arte4.y = -450;
			...
			le1 = Assets.imagem(Assets.levelzoo1);
			le1.width = 2048;
			le1.height = 1600;
			le1.x = 5;
			le1.y = -75;
			...
			le2  = Assets.imagem(Assets.levelzoo2);
			le2.width = 1000;
			le2.height = 1600;
			le2.x = 2000;
			le2.y = -73;
			...
			*/
			...
			criainimigos(800, 290, 0xff00ff, "tigre");
			criainimigos(600, 100, 0xff00ff, "passaro");
			criainimigos(1100, 100, 0xff00ff, "atira");
			criainimigos(1300, 290, 0xff00ff, "soldado");
			criainimigos(1550, 290, 0xff00ff, "atira");
			criainimigos(1800, 100, 0xff00ff, "passaro");
			//criainimigos(2050, 290, 0xff00ff, "touro");
			criainimigos(2350, 290, 0xff00ff, "tigre");
			criainimigos(2550, 100, 0xff00ff, "passaro");
			criainimigos(2350, 530, 0xff00ff, "tigre");
			criainimigos(2300, 650, 0xff00ff, "passaro");
			criainimigos(2250, 530, 0xff00ff, "soldado");
			criainimigos(2100, 530, 0xff00ff, "passaro");
			criainimigos(2150, 650, 0xff00ff, "berserk");
			criainimigos(1850, 650, 0xff00ff, "passaro");
			criainimigos(1650, 530, 0xff00ff, "soldado");
			criainimigos(1200, 530, 0xff00ff, "berserk");
			criainimigos(1100, 700, 0xff00ff, "atira");
			criainimigos(950, 530, 0xff00ff, "passaro");
			criainimigos(650, 650, 0xff00ff, "passaro");
			criainimigos(600, 530, 0xff00ff, "berserk");
			criainimigos(50, 530, 0xff00ff, "passaro");
			criainimigos(200, 650, 0xff00ff, "touro");
			
			criainimigos(-350, 1200, 0xff00ff, "atira");
			
			
			criaplataforma(2950, -510, 500, 1400, 0x00ff00, 1);
			criaplataforma(0, -810, 50, 1700, 0x00ff00, 1);
			criaplataforma( 0, 340, 450, 50, 0x00ff00, 1);
			criaplataforma(400, 390, 350, 50, 0x00ff00, 1);
			criaplataforma(700, 340, 350, 50, 0x00ff00, 1);
			criaplataforma(1000, 390, 450, 50, 0x00ff00, 1);
			criaplataforma(1400, 340, 200, 50, 0x00ff00, 1);
			criaplataforma(1550, 390, 300, 50, 0x00ff00, 1);
			criaplataforma(1800, 340, 300, 50, 0x00ff00, 1);
			criaplataforma(2050, 390, 350, 50, 0x00ff00, 1);
			criaplataforma(2350, 340, 400, 50, 0x00ff00, 1);
			criaplataforma(2900, 390, 50, 50, 0x00ff00, 1);///////
			criaplataforma(-3500, 740, 7000, 100, 0x00ff00, 1);
			criaplataforma(2750, 590, 400, 20, 0x00ff00, 2);
			criaplataforma(450, 590, 2150, 20, 0x00ff00, 2);
			criaplataforma(1800, 340, 50, 300, 0x00ff00, 1);
			criaplataforma(1550, 590, 50, 250, 0x00ff00, 1);
			criaplataforma(1400, 340, 50, 300, 0x00ff00, 1);
			criaplataforma(1000, 590, 50, 250, 0x00ff00, 1);
			criaplataforma(700, 340, 50, 300, 0x00ff00, 1);
			criaplataforma(400, 590, 50, 250, 0x00ff00, 1);
			criaplataforma(300, 590, 150, 20, 0x00ff00, 2);
		
			criaplataforma(400, 150, 250, 20, 0x00ff00, 2);
			criaplataforma(1050, 150, 250, 20, 0x00ff00, 2);
			criaplataforma(1700, 150, 250, 20, 0x00ff00, 2);
			criaplataforma(2350, 150, 250, 20, 0x00ff00, 2);
			criaplataforma(0, 590, 150, 20, 0x00ff00, 2);
		
			criaplataforma( 0, -810, 3000, 800, 0x00ff00, 1);
		...
		public function matacarai():void {
			...
			for (var i:int = 0; i < ruim.length; i++) {
				if (colision(ruim[i].hitbox(), hitH)) {
					...
					if (ruim[i].tipo == "soldado" || ruim[i].tipo == "atira"||ruim[i].tipo == "berserk") {
					morte.play();
					}else {
					pasmor.play();	
					}
